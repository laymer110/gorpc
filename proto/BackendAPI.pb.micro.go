...
type BackendAPIService interface {
	Migration(ctx context.Context, in *DBTableInfo, opts ...client.CallOption) (*MigrationResult, error)
...
func (c *backendAPIService) Migration(ctx context.Context, in *DBTableInfo, opts ...client.CallOption) (*MigrationResult, error) {
	req := c.c.NewRequest(c.name, "BackendAPI.Migration", in)
...
type BackendAPIHandler interface {
	Migration(context.Context, *DBTableInfo, *MigrationResult) error
...
func RegisterBackendAPIHandler(s server.Server, hdlr BackendAPIHandler, opts ...server.HandlerOption) error {
	type backendAPI interface {
		Migration(ctx context.Context, in *DBTableInfo, out *MigrationResult) error
...
func (h *backendAPIHandler) Migration(ctx context.Context, in *DBTableInfo, out *MigrationResult) error {
	return h.BackendAPIHandler.Migration(ctx, in, out)
}
